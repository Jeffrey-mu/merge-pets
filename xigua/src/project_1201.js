window.__require = function e(t, n, o) {
      ...
      var a = e("../common/PlayerInfo")
        ...
        , m = function(e) {
          ...
          t.prototype.start = function() {
              ...
              this.createOneFruit(firstFruit)
          }
          ,
          t.prototype.update = function(e) {
          ...
          t.prototype.createOneFruit = function(e) {
              if (!d.default.Instance.override) {
                  if (background) {
                      const bg = cc.find("Canvas/bgLayer").getComponent(cc.Sprite);
                      cc.loader.load(background, function(err, o) {
                          if (!err) {
                              bg.spriteFrame = new cc.SpriteFrame(o)
                          }
                      })
                  }
                  for (let index = 0; index < overrideFruit.length; index++) {
                      const old = d.default.Instance.fruit[index];
                      const item = overrideFruit[index];
                      if (old._textureFilename !== item.src) {
                          let rect = cc.rect(item.rect[0], item.rect[1], item.rect[2], item.rect[3]);
                          let offset = cc.size(item.offset[0], item.offset[1]);
                          let size = cc.size(item.size[0], item.size[1]);
                          let sprite = new cc.SpriteFrame(item.src,rect,false,offset,size);
                          sprite.name = item.name;
                          d.default.Instance.fruit[index] = sprite
                      }
                  }
                  d.default.Instance.override = true;
                  console.log("资源重载完成")
              }
              var t = this
      ...
      var a = e("./GameFunction")
        ...
        , p = function(e) {
          ...
          t.prototype.onTouchEnd = function(e) {
              ...
              a.default.Instance.targetFruit.getComponent(cc.RigidBody).active = true,
              ...
              this.scheduleOnce(function() {
                  if (setFruits) {
                      ...
                      i.default.GameUpdateCtrl && (startFruits.length > t.createFruitCount ? (a.default.Instance.createOneFruit(startFruits[t.createFruitCount]),
                      t.createFruitCount++) : (a.default.Instance.createOneFruit(setFruits.randomFunction()),
                      t.createFruitCount++))
                  } else {
  ...
  MainGameJS: [function(e, t, n) {
      ...
      cc.Class({
          ...
          onLoad: function() {
              var e = function() {
                  var e = navigator.userAgent
                    ...
                    , o = /(?:Android)/.test(e)
                    , a = /(?:Firefox)/.test(e)
                    , c = (/(?:Chrome|CriOS)/.test(e),
                  /(?:iPad|PlayBook)/.test(e) || o && !/(?:Mobile)/.test(e) || a && /(?:Tablet)/.test(e))
                    , i = /(?:iPhone)/.test(e) && !c;
                  return {
                      isTablet: c,
                      isPhone: i,
          ...
          play: function() {
              a.ajax(`${location.origin}/xigua/api/game/load`, {
                  gameId: gameId
              }, function() {});
              var e = this;
              adBreak({
  ...
  MainManage: [function(e, t, n) {
        ...
        , r = (e("GameUiTools"),
      {
          ...
          getHttpGameId: function() {
              ...
              this.moreGameUrl = location.origin
          },
          gameOverShowText: function(e) {
              this.ajax(`${location.origin}/xigua/api/game/over`, {
                  gameId: gameId,
                  score: e
          ...
          t.prototype.onBeginContact = function(e, t, n) {
              ...
              "fruit" == n.node.group) {
                  ...
                  cc.tween(t.node).to(.1, {
                      ...
                      n.node.destroy(),
                      t.node.destroy()
                  }).start())) : c == r && border == c && border == r && (this.pengzhuangCount += 1,
                  0 == t.node.getComponent("fruitData").getNumber() && (a.default.score += this.fruitNumber + 1,
                  u.default.Instance.SetScoreTween(a.default.score),
                  n.node.getComponent(cc.PhysicsCircleCollider).radius = 0,
                  n.node.getComponent(cc.PhysicsCircleCollider).apply(),
                  ...
                  cc.tween(t.node).to(.1, {
                      ...
                      var c = new cc.Node;
                      c.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[reverseLevelUp ? 0 : 10],
                      ...
                      var s = new cc.Node;
                      s.addComponent(cc.Sprite).spriteFrame = l.default.Instance.fruit[reverseLevelUp ? 0 : 10],
                      s.parent = c,
                      s.position = cc.v2(0),
